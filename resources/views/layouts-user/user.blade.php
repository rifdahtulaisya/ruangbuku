...
<head>
    ...
    <body class="min-h-screen flex flex-col overflow-x-hidden bg-gradient-to-br from-[#C4B5A5] via-[#A27B5C]/40 to-[#D4C4B5]">
    <!-- Sidebar -->
    <x-sidebar-user />
    ...
    <footer
        class="mt-10 px-6 py-4 text-sm text-slate-500 flex justify-between items-center
